# Spec: Weekly Email Report

## Purpose
Governs the composition and delivery of the weekly beats CVE email report to Elastic, including diff logic, full-report override, and recipient configuration.
